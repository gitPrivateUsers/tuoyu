package org.pussinboots.ttui.os.common.config;
...
@EnableSwagger2
@EnableWebMvc
@ComponentScan(basePackages = {"org.pussinboots.ttui.os.controller"})
public class SwaggerConfig {
	
   @Bean  
    public Docket platformApi() {  
        return new Docket(DocumentationType.SWAGGER_2)  
        		.groupName("ttui-os-web")
                .apiInfo(apiInfo())  
    ...
    private ApiInfo apiInfo() {  
        return new ApiInfoBuilder()  
                .title("ttui-os-web RESTful APIs")
