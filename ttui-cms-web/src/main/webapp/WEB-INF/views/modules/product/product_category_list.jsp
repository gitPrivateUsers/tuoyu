                ...
                <div class="example">
                  <div id="toolbar" class="btn-group m-t-sm">
                    <shiro:hasPermission name="product:detail:create">
                      <button type="button" class="btn btn-default"  title="添加商品分类" onclick="layer_show('添加商品分类','${ctx}/product/detail/create','800','700')"> <i class="glyphicon glyphicon-plus"></i> </button>
                    </shiro:hasPermission>
                  </div>
                  <table id="table"
                         data-toggle="table"
                    ...
                    <thead>
                    <tr>
                      <th data-field="productId" data-halign="center" data-align="center" data-sortable="true">商品分类ID</th>
                      <th data-field="productNumber" data-halign="center" data-align="center" data-sortable="true">商品ID</th>
                      <th data-field="name" data-halign="center" data-align="center" data-sortable="true">分类ID</th>
                      <th data-formatter="timeFormatter" data-field="showPrice" data-halign="center" data-align="center" data-sortable="true">创建时间</th>
                      <th data-field="introduce" data-halign="center" data-align="center" data-sortable="true">创建者</th>
...
<myfooter>
  ...
  <!-- 自定义js -->
  <script src="${ctxsta}/cms/js/productCategory1.js"></script>
</myfooter>
</body>
</html>